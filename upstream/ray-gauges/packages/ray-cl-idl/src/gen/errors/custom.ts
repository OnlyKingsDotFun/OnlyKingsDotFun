...
export class ZeroAmountSpecified extends Error {
  static readonly code = 6024
  readonly code = 6024
  readonly name = "ZeroAmountSpecified"
...
export class MaxTokenOverflow extends Error {
  static readonly code = 6042
  readonly code = 6042
  readonly name = "MaxTokenOverflow"
  readonly msg = "Max token overflow"

  constructor(readonly logs?: string[]) {
    super("6042: Max token overflow")
  }
}

export class CalculateOverflow extends Error {
  static readonly code = 6043
  readonly code = 6043
  readonly name = "CalculateOverflow"
  readonly msg = "calculate overflow"

  constructor(readonly logs?: string[]) {
    super("6043: calculate overflow")
  }
}
...
export function fromCode(code: number, logs?: string[]): CustomError | null {
  switch (code) {
    ...
    case 6024:
      return new ZeroAmountSpecified(logs)
    case 6025:
    ...
    case 6042:
      return new MaxTokenOverflow(logs)
    case 6043:
      return new CalculateOverflow(logs)
  }
